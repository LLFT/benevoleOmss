...
<form  class="form-horizontal" action="" method="POST" >
	...
	<div class="form-group">
		...
		<div class="col-sm-2"><?php echo $oForm->getInputText('date',array('class'=>'form-control'))?></div>
		<label class="col-sm-1 control-label">Lieux</label>
		<div class="col-sm-4"><?php echo $oForm->getInputText('lieux',array('class'=>'form-control'))?></div>
	</div>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
		<input type="submit" class="btn btn-success" value="Ajouter" /> <a class="btn btn-link" href="<?php echo $this->getLink('events::list')?>">Annuler</a>
	</div>
</div>
</form>
