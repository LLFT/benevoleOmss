<?php
class model_groupe extends abstract_model{
	
	protected $sClassRow='row_groupe';
	
	protected $sTable='groupe';
	protected $sConfig='benevoleOmss';
	
	protected $tId=array('idGroupe');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE idGroupe=?',$uId );
	}
	...
	public function getSelect(){
		...
		if($tab){
                    foreach($tab as $oRow){
                            $tSelect[ $oRow->idGroupe ]=$oRow->name;
                    }
		}
		return $tSelect;
	}
...
class row_groupe extends abstract_row{
	
	protected $sClassModel='model_groupe';
