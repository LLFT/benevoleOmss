<?php
class model_element extends abstract_model{
	
	protected $sClassRow='row_element';
	
	protected $sTable='element';
	protected $sConfig='benevoleOmss';
	
	protected $tId=array('idElement');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE idElement=?',$uId );
	}
...
class row_element extends abstract_row{
	
	protected $sClassModel='model_element';
